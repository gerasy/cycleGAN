...
#$ -t 1-2 # start 2 instances: to train different models in parallel
#Cluster settings, 
import os
try:
...
targetEpoch = 100
saveAt = 20 #how often to store the model (stores if epoch % saveAt == 0 || epoch == n_epochs-1 )
...
param_train_cycle_list = [param_train3, param_train8]
